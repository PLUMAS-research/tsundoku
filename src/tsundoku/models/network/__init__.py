...
import graph_tool.inference as inference
...
class Network(object):
    ...
    def layout_nodes(self, *args, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        Los métodos disponibles son "force-directed", "precomputed", and "radial".
    ...
    """
        ...
        if remove_isolated:
            ...
            view = GraphView(view, vfilt=degree > 0).copy()
    ...
    def estimate_betweenness(self, **kwargs):
        ...
        **kwargs: argumentos de palabras clave
        ...
        node_centrality, edge_centrality = centrality.betweenness(
    ...
    def estimate_pagerank(self, **kwargs):
        ...
        **kwargs: argumentos de palabras clave
        ...
        node_centrality = centrality.pagerank(
            self.network, weight=weight, **kwargs
        )
    ...
    def connected_components(self, directed=True):
        ...
        """
        return topology.label_components(self.network, directed=directed)
    ...
    def detect_communities(
        ...
        if method == "sbm":
            self.state = inference.minimize_blockmodel_dl(
            ...
            self.state = inference.minimize_nested_blockmodel_dl(
            ...
            state_args["base_type"] = inference.RankedBlockState
            self.state = inference.minimize_nested_blockmodel_dl(
                self.network, state_args=state_args
            )
    ...
    def _build_community_tree(self):
        ...
        (
            ...
            membership,
            order,
        ) = inference.nested_blockmodel.get_hierarchy_tree(
    ...
    """
        ...
        depth_edges = search.dfs_iterator(tree, source=root, array=True)
